...
ARG VITE_USE_MOCK_MODULE_PIPELINE=false
ARG VITE_ENABLE_LOGIN=true
ARG VITE_PASSWORD_HASH_KEY=spice_uat
ARG VITE_HMAC_SECRET_KEY=spice_uat
...
ARG VITE_COACHING_SUITE_ACCESS=admin
...
ENV VITE_API_BASE_URL=$VITE_API_BASE_URL \
    ...
    VITE_USE_MOCK_MODULE_PIPELINE=$VITE_USE_MOCK_MODULE_PIPELINE \
    VITE_ENABLE_LOGIN=$VITE_ENABLE_LOGIN \
    VITE_PASSWORD_HASH_KEY=$VITE_PASSWORD_HASH_KEY \
