...
const sectionTitleClassName =
  'px-3 pt-2 text-[10px] font-semibold tracking-wider text-slate-400';
  ...
  return (
    <aside className="sticky top-0 flex h-screen w-64 shrink-0 flex-col border-r border-slate-200 bg-white">
      <div className="px-5 pb-4 pt-5">
        ...
        <div className="mt-2 inline-flex items-center rounded-full bg-blue-50 px-2 py-0.5 text-[10px] font-semibold text-blue-700">
