...
import {
  ModulePreviewChrome,
  ModulePreviewToggleButton,
} from '@/features/modules/components/module-preview/ModulePreviewChrome';
...
import { useAdminModuleReviewNavigation } from '@/features/modules/hooks/useAdminModuleReviewNavigation';
...
export const AdminModuleReviewLayout = () => {
  ...
  const { dialogOpen: explanationReviewDialogOpen, handleReviewExplanations } =
    useQuizExplanationReview(moduleId);
  const { versionConflict, isReloading, dismissConflict, reloadLatestTip } =
    useModuleVersionConflictReload(moduleId);
    ...
    <ModulePreviewProvider moduleId={moduleId}>
      <section className="space-y-4">
        <QuizExplanationReviewDialog
          open={explanationReviewDialogOpen}
        ...
        <UnsavedChangesDialog
          ...
          isSaving={isSaving}
        />
        <ModuleVersionConflictDialog
          open={versionConflict != null}
          currentVersion={versionConflict?.current_version}
