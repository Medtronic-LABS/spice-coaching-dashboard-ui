import { useGetAdminFilePresignedUrlQuery } from '@/features/modules/api/adminFilesApi';
import { objectNameFromUploadedFileUrl } from '@/features/modules/utils/uploadedFileUrl';
