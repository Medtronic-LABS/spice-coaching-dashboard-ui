...
export type AssignmentSuccessPresentation = 'page' | 'modal';
...
export interface AssignmentSuccessCardProps {
  state: AssignmentSuccessLocationState;
  presentation: AssignmentSuccessPresentation;
  onAssignMore?: () => void;
  onPrimaryAction: () => void;
}

export const AssignmentSuccessCard = ({
  state,
  presentation,
  onAssignMore,
  onPrimaryAction,
}: AssignmentSuccessCardProps) => {
  ...
  const derivedAssignedUsers = useMemo(() => {
  ...
  const primaryLabel =
    presentation === 'modal'
      ? t('moduleLibrary.assigned.next.done')
      : copy.backToLibrary;
...
export interface AssignmentSuccessModalProps {
  open: boolean;
  state: AssignmentSuccessLocationState;
  onClose: () => void;
  onAssignMore?: () => void;
...
export const AssignmentSuccessModal = ({
  open,
  state,
  onClose,
  onAssignMore,
