...
import type { KnowledgeUploadPayload } from '@/features/knowledge-library/api/adminKnowledgeApi';
...
vi.mock(
  '@/features/knowledge-library/api/adminKnowledgeApi',
  async (importOriginal) => {
    const actual =
      await importOriginal<
        typeof import('@/features/knowledge-library/api/adminKnowledgeApi')
      >();
...
vi.mock(
  '@/features/knowledge-library/components/KnowledgeLibraryTable',
  () => ({
    KnowledgeLibraryTable: () => <div data-testid="knowledge-library-table" />,
  }),
);

vi.mock('@/features/knowledge-library/hooks/useKnowledgePdfDocument', () => ({
