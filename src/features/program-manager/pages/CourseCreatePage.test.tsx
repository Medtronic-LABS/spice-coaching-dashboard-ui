...
vi.mock('@/features/module-library/utils/ingestSessionStorage', () => ({
...
vi.mock(
  '@/features/module-library/api/adminIngestApi',
  async (importOriginal) => {
    const actual =
      await importOriginal<
        typeof import('@/features/module-library/api/adminIngestApi')
      >();
    return {
      ...actual,
